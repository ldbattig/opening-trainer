...
export function getLegalMovesBasic(piece: ChessPiece, board: BoardState, skipCheckFilter = false): Position[] {
...
export function getLegalMoves(piece: ChessPiece, board: BoardState): Position[] {
